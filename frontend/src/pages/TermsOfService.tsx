...
const TermsOfService = () => {
  ...
  const sections = [
    ...
    { id: 9, titleKey: "terms.section9.title", contentKey: "terms.section9.content" },
    { id: 10, titleKey: "terms.section10.title", contentKey: "terms.section10.content" },
    { id: 11, titleKey: "terms.section11.title", contentKey: "terms.section11.content" },
    { id: 12, titleKey: "terms.section12.title", contentKey: "terms.section12.content" },
    { id: 13, titleKey: "terms.section13.title", contentKey: "terms.section13.content" },
    { id: 14, titleKey: "terms.section14.title", contentKey: "terms.section14.content" },
    { id: 15, titleKey: "terms.section15.title", contentKey: "terms.section15.content" },
  ];

...
import { UserActivityCategory } from "@/shared/types";
...
const Notifications = () => {
  ...
  const getActivityColor = (type: string): string => {
    if (type.toLowerCase().includes("listing")) return "text-blue-600";
    if (type.toLowerCase().includes("pickup")) return "text-green-600";
    if (type.toLowerCase().includes("transaction")) return "text-emerald-600";
    if (type.toLowerCase().includes("rating")) return "text-yellow-600";
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-4">
            ...
            >
              <SelectTrigger className="w-[200px]">
                <SelectValue placeholder={t("notifications.filterByType", { defaultValue: "Filter by type" })} />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value={UserActivityCategory.All}>{t("notifications.allTypes", { defaultValue: "All Types" })}</SelectItem>
                        ...
                        {activity.rating && (
                          <div className="mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                            <div className="flex items-center gap-2 mb-1">
                              <span className="text-lg">{"⭐".repeat(activity.rating.value)}</span>

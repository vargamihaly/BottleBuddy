...
import {GetUserActivitiesParams, userActivityService} from "@/features/notifications/api/userActivity.service";
 ...
 */
export const useUserActivities = (params?: GetUserActivitiesParams, options?: {
    enabled?: boolean;

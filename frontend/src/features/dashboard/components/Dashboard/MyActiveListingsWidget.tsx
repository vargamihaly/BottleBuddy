                        ...
                        >
                            <div className="flex items-start justify-between gap-3">
                                <div className="flex items-start gap-3 flex-1 min-w-0">
                                    <div
                                        className="w-10 h-10 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                                        {listing.bottleCount}
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center justify-between gap-2">
                                            ...
                                            {listing.pendingRequests && listing.pendingRequests > 0 && (
                                                <Badge variant="default"
                                                       className="bg-orange-100 text-orange-700 text-xs flex-shrink-0">
